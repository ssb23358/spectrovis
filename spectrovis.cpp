...
/* STFT parameters */
static constexpr int WINDOW_LEN    = 1024;       
static constexpr int ZERO_PAD      = 4;      
static constexpr int FFT_SIZE      = WINDOW_LEN * ZERO_PAD;  /* 4096 */
static constexpr int HOP_SIZE      = WINDOW_LEN / 2; 

static constexpr int   MEL_BANDS = 128;
static constexpr float MEL_FMIN  = 20.f;
static constexpr float MEL_FMAX  = 16000.f;

static constexpr int   LUFS_BLOCK_MS   = 400; 
static constexpr float LUFS_OVERLAP    = 0.75f;
static constexpr float LUFS_ABS_GATE   = -70.f;
static constexpr float LUFS_REL_OFFSET = -10.f;

static constexpr int SG_HALFWIN_LUFS = 15;
static constexpr int SG_HALFWIN_FEAT = 20;
static constexpr int SG_POLY_ORDER   = 3; 
